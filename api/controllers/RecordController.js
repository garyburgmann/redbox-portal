...
(function (Controllers) {
    class Record extends controller.Controllers.Core.Controller {
        ...
        create(req, res) {
            ...
            record.metaMetadata.createdOn = moment_es6_1.default().format();
        ...
        mergeFields(req, res, fields, type, currentRec) {
        ...
        mergeFieldsSync(req, res, fields, currentRec, workflowSteps) {
            ...
            _.forEach(fields, (field) => {
                if (!_.isEmpty(field.definition.name) && !_.isUndefined(field.definition.name)) {
                    ...
                    else if (_.has(metadata, field.definition.name)) {
        ...
        getPermissionsInternal(req, res) {
            return __awaiter(this, void 0, void 0, function* () {
                sails.log.verbose('getting attachments....');
                const oid = req.param('oid');
                let record = yield this.getRecord(oid).toPromise();
                let response = {};
                ...
                for (let i = 0; i < editUsers.length; i++) {
                    ...
                    let user = yield UsersService.getUserWithUsername(editUsername).toPromise();
                ...
                for (let i = 0; i < viewUsers.length; i++) {
                    ...
                    let user = yield UsersService.getUserWithUsername(viewUsername).toPromise();
